...
import com.example.quranproject.databinding.FragmentQuranBinding
import com.example.quranproject.ui.chapterDetails.ChapterDetailsActivity
...
class QuranFragment:Fragment() {
    ...
    lateinit var adapter: ChapterNamesRecyclerAdapter

    private fun initRecyclerView() {
        adapter = ChapterNamesRecyclerAdapter(names)

        adapter.onItemClickListener =
            ChapterNamesRecyclerAdapter.OnItemClickListener { position, name ->
                //send Chapter name -position to
                //start suraDeteils Activity
